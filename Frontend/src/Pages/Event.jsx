...
const Event = () => {
  return (
    <div>
      ...
      <div className="bg-white  my-10 md:my-20 px-4">
        <div className="flex flex-col justify-center items-center">
          ...
          <p className="max-w-[410px] text-center text-[18px] text-[#541F03] font-light">
      ...
      <div className="flex flex-col justify-center items-center mt-10 md:mt-36 text-[#541F03] px-4">
        <a href="#" className="w-full max-w-[616px]">
          <img
        ...
        <div className="mb-10 md:mb-32 w-full max-w-[616px]">
        <div className="">
